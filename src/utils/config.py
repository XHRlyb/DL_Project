...
__C.GMN.PI_ITER_NUM = 25
__C.GMN.PI_STOP_THRESH = 1.e-3
__C.GMN.BS_ITER_NUM = 20
__C.GMN.BS_EPSILON = 1.e-10
__C.GMN.VOTING_ALPHA = 200.
...
# pretrained_path
__C.PRETRAINED_PATH = 'pretrained/pretrained_params_vgg16_gmn_voc.pt'
